package com.ajioShopping.actiondriver;
...
import com.ajioShopping.actionInterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface {
	...
	public boolean selectByIndex(WebElement element, int index) {
		...
		try {
			...
			if (flag) {
				System.out.println("Option selected by Index vlaue");
			} else {
				System.out.println("Option Not selected by Index value");
			}
		}
	...
	public boolean selectByValue(WebElement element, String value) {
		...
		try {
			...
			if(flag) {
				System.out.println("Option selected by Vlaue");
			} else {
				System.out.println("Option Not selected by Vlaue");
			}
		}
	}
	...
	public boolean selectByVisibleText(WebElement ele, String visibletext) {
		...
		try {
			...
			if(flag) {
				...
				System.out.println("Option Not select by visible text");
			}
		}
	}
	...
	public boolean mouseHoverByJavaScript(WebElement locator) {
		...
		try {
			...
			String javaScript = "var evObj = document.createEvent('MouseEvents');"
					+"evnObj.initMouseEvent(\"mouseover\", true, false, window, 0, 0, 0, 0, 0, false, false, false, false, 0, null);"
	...
	public boolean switchToFrameByIndex(WebDriver driver, int index) {
		...
		try {
			...
			wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//iframe")));
